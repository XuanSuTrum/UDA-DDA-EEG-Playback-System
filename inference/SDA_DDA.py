# -*- coding: utf-8 -*-
"""UDA-DDA transfer network definition."""

# -*- coding: utf-8 -*-
"""Model components kept for reproducing the offline inference path."""
#娌℃湁澶氬昂搴?鏈塩mmd
...
class Transfer_Net(nn.Module):
    def __init__(self, num_class, base_net='CFE', transfer_loss='mmd', use_bottleneck = False,width=32, confidence_threshold = 0.35, input_dim=310):
        super(Transfer_Net, self).__init__()
        self.input_dim = input_dim
        self.base_network = backbone.network_dict[base_net](input_dim=input_dim)
    ...
    def forward(self, e, source, target, s_label):
        ...
        if 0 <= e < 10:
            ...
            # 濡傛灉 e 瓒呭嚭浜嗕笂杩拌寖鍥达紝浣犲彲鑳介渶瑕佽€冭檻濡備綍澶勭悊
